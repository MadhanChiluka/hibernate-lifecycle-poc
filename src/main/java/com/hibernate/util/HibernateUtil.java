    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                eventListenerRegistry.getEventListenerGroup(EventType.PRE_UPDATE).appendListener(new PreInsertListener());
//                eventListenerRegistry.getEventListenerGroup(EventType.PRE_INSERT).appendListener(new PreInsertListener());
